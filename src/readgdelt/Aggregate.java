...
import static dataloadermysql.DataLoaderMySQL.aggregatedFileRawCount;
...
//                                  System.out.println("HERE! 1 pointer: " + lat + "\t" + lon);
                        ...
                        while ((Line = br1.readLine()) != null) {
                            ...
                            if(lat1.equals(lat) && lon1.equals(lon)){
                                ...
                                if(attr[4].equals("020") || attr[4].equals("021") ||attr[4].equals("0212")||
                                ...
                                //System.out.println("HERE! 3 pointer" );
                                    ...
                                    protest++;
                                        ...
                                        attr[4].equals("1724") ||attr[4].equals("173") ||attr[4].equals("173") ||attr[4].equals("175") ||
                                        attr[4].equals("176") ){
                                    //missing 174
                                    coerce++;
                                }
                ...
                aggregatedFileRawCount = aggregateRowCount;
                out.close();
                br.close();
            } // if txt file
        }
